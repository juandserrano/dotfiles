    ...
    opts = {
      ...
      on_attach = function(bufnr)
        vim.keymap.set('n', '<leader>gk', require('gitsigns').prev_hunk,
          { buffer = bufnr, desc = '[G]o to Previous Hunk' })
        vim.keymap.set('n', '<leader>gj', require('gitsigns').next_hunk, { buffer = bufnr, desc = '[G]o to Next Hunk' })
...
vim.keymap.set({ 'n', 'v' }, '<leader>e', ':Ex<CR>', { silent = true })
...
vim.keymap.set('n', '<leader><space>n', require('telescope.builtin').buffers, { desc = '[ ] Find existing buffers' })
...
vim.keymap.set('n', '<leader><space>g', require('telescope.builtin').git_files, { desc = 'Search [G]it [F]iles' })
vim.keymap.set('n', '<leader>sf', require('telescope.builtin').find_files, { desc = '[S]earch [F]iles' })
vim.keymap.set('n', '<leader>sh', require('telescope.builtin').help_tags, { desc = '[S]earch [H]elp' })
vim.keymap.set('n', '<leader>sw', require('telescope.builtin').grep_string, { desc = '[S]earch current [W]ord' })
vim.keymap.set('n', '<leader>st', require('telescope.builtin').live_grep, { desc = '[S]earch by Grep' })
...
vim.keymap.set('n', '<leader>lv', vim.diagnostic.setloclist, { desc = 'Open diagnostics list' })
